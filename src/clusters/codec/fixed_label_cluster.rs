//! Matter TLV encoders and decoders for Fixed Label Cluster
//! Cluster IDs: 0x0040
//!
//! This file is automatically generated from FixedLabel-Cluster.xml
...
pub fn decode_attribute_json(cluster_id: u32, attribute_id: u32, tlv_value: &crate::tlv::TlvItemValue) -> String {
    ...
    if ![0x0040].contains(&cluster_id) {
        return format!("{{\"error\": \"Invalid cluster ID. Expected [0x0040], got {}\"}}", cluster_id);
    }
