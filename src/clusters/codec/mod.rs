...
pub fn decode_event_json(cluster_id: u32, event_id: u32, tlv_value: &crate::tlv::TlvItemValue) -> String {
    match cluster_id {
        ...
        0x002A => ota_requestor::decode_event_json(cluster_id, event_id, tlv_value),
        0x002F => power_source_cluster::decode_event_json(cluster_id, event_id, tlv_value),
        0x0033 => diagnostics_general::decode_event_json(cluster_id, event_id, tlv_value),
        0x0034 => diagnostics_software::decode_event_json(cluster_id, event_id, tlv_value),
        0x0035 => diagnostics_thread::decode_event_json(cluster_id, event_id, tlv_value),
        0x0036 => diagnostics_wifi::decode_event_json(cluster_id, event_id, tlv_value),
        0x0038 => time_sync::decode_event_json(cluster_id, event_id, tlv_value),
        0x0039 => bridged_device_basic_information_cluster::decode_event_json(cluster_id, event_id, tlv_value),
        0x003B => switch::decode_event_json(cluster_id, event_id, tlv_value),
        0x0045 => boolean_state::decode_event_json(cluster_id, event_id, tlv_value),
        0x005C => smoke_co_alarm::decode_event_json(cluster_id, event_id, tlv_value),
        0x0060 => operational_state::decode_event_json(cluster_id, event_id, tlv_value),
        0x0065 => groupcast::decode_event_json(cluster_id, event_id, tlv_value),
        0x0080 => boolean_state_configuration::decode_event_json(cluster_id, event_id, tlv_value),
        0x0081 => valve_configuration_control::decode_event_json(cluster_id, event_id, tlv_value),
        0x0090 => electrical_power_measurement::decode_event_json(cluster_id, event_id, tlv_value),
        0x0091 => electrical_energy_measurement::decode_event_json(cluster_id, event_id, tlv_value),
        0x0094 => water_heater_management::decode_event_json(cluster_id, event_id, tlv_value),
        0x0095 => commodity_price::decode_event_json(cluster_id, event_id, tlv_value),
        0x0097 => messages::decode_event_json(cluster_id, event_id, tlv_value),
        0x0098 => device_energy_management::decode_event_json(cluster_id, event_id, tlv_value),
        0x0099 => energy_evse::decode_event_json(cluster_id, event_id, tlv_value),
        0x00A0 => electrical_grid_conditions::decode_event_json(cluster_id, event_id, tlv_value),
        0x0101 => door_lock::decode_event_json(cluster_id, event_id, tlv_value),
        0x0104 => closure_control::decode_event_json(cluster_id, event_id, tlv_value),
        ...
        0x050F => content_control::decode_event_json(cluster_id, event_id, tlv_value),
        0x0550 => zone_management::decode_event_json(cluster_id, event_id, tlv_value),
        0x0555 => push_av_stream_transport::decode_event_json(cluster_id, event_id, tlv_value),
        0x0556 => chime::decode_event_json(cluster_id, event_id, tlv_value),
        0x0751 => commissioner_control_cluster::decode_event_json(cluster_id, event_id, tlv_value),
        _ => format!("{{\"error\": \"Unsupported cluster ID: {}\"}}", cluster_id),
    }
}
...
pub fn get_event_list(cluster_id: u32) -> Vec<(u32, &'static str)> {
    match cluster_id {
        ...
        0x002A => ota_requestor::get_event_list(),
        0x002F => power_source_cluster::get_event_list(),
        0x0033 => diagnostics_general::get_event_list(),
        0x0034 => diagnostics_software::get_event_list(),
        0x0035 => diagnostics_thread::get_event_list(),
        0x0036 => diagnostics_wifi::get_event_list(),
        0x0038 => time_sync::get_event_list(),
        0x0039 => bridged_device_basic_information_cluster::get_event_list(),
        0x003B => switch::get_event_list(),
        0x0045 => boolean_state::get_event_list(),
        0x005C => smoke_co_alarm::get_event_list(),
        0x0060 => operational_state::get_event_list(),
        0x0065 => groupcast::get_event_list(),
        0x0080 => boolean_state_configuration::get_event_list(),
        0x0081 => valve_configuration_control::get_event_list(),
        0x0090 => electrical_power_measurement::get_event_list(),
        0x0091 => electrical_energy_measurement::get_event_list(),
        0x0094 => water_heater_management::get_event_list(),
        0x0095 => commodity_price::get_event_list(),
        0x0097 => messages::get_event_list(),
        0x0098 => device_energy_management::get_event_list(),
        0x0099 => energy_evse::get_event_list(),
        0x00A0 => electrical_grid_conditions::get_event_list(),
        0x0101 => door_lock::get_event_list(),
        0x0104 => closure_control::get_event_list(),
        ...
        0x050F => content_control::get_event_list(),
        0x0550 => zone_management::get_event_list(),
        0x0555 => push_av_stream_transport::get_event_list(),
        0x0556 => chime::get_event_list(),
        0x0751 => commissioner_control_cluster::get_event_list(),
        _ => vec![],
    }
}
