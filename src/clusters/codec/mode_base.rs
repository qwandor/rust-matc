//! Matter TLV encoders and decoders for Mode Base Cluster
//! Cluster IDs: 
//!
//! This file is automatically generated from ModeBase.xml
...
/// Decode ChangeToModeResponse command response (01)
pub fn decode_change_to_mode_response(inp: &tlv::TlvItemValue) -> anyhow::Result<ChangeToModeResponse> {
    if let tlv::TlvItemValue::List(_fields) = inp {
        let item = tlv::TlvItem { tag: 0, value: inp.clone() };
        Ok(ChangeToModeResponse {
