//! Matter TLV encoders and decoders for Laundry Washer Mode Cluster
//! Cluster IDs: 0x0051
//!
//! This file is automatically generated from Mode_LaundryWasher.xml
...
impl ModeTag {
    ...
    pub fn from_u16(value: u16) -> Option<Self> {
        match value {
            ...
            16385 => Some(ModeTag::Delicate),
            16386 => Some(ModeTag::Heavy),
            16387 => Some(ModeTag::Whites),
            _ => None,
        }
    }
...
pub fn decode_attribute_json(cluster_id: u32, attribute_id: u32, tlv_value: &crate::tlv::TlvItemValue) -> String {
    ...
    if ![0x0051].contains(&cluster_id) {
        return format!("{{\"error\": \"Invalid cluster ID. Expected [0x0051], got {}\"}}", cluster_id);
    }
