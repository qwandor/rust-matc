//! Matter TLV encoders and decoders for Refrigerator And Temperature Controlled Cabinet Mode Cluster
//! Cluster IDs: 0x0052
//!
//! This file is automatically generated from Mode_Refrigerator.xml
...
/// Read `SupportedModes` attribute from cluster `Refrigerator And Temperature Controlled Cabinet Mode`.
...
/// Read `CurrentMode` attribute from cluster `Refrigerator And Temperature Controlled Cabinet Mode`.
...
/// Read `StartUpMode` attribute from cluster `Refrigerator And Temperature Controlled Cabinet Mode`.
...
/// Read `OnMode` attribute from cluster `Refrigerator And Temperature Controlled Cabinet Mode`.
