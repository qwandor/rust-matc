...
//! Cluster IDs: 0x0071, 0x0072, 0x0079
//!
...
pub fn decode_attribute_json(cluster_id: u32, attribute_id: u32, tlv_value: &crate::tlv::TlvItemValue) -> String {
    ...
    if ![0x0071, 0x0072, 0x0079].contains(&cluster_id) {
        return format!("{{\"error\": \"Invalid cluster ID. Expected [0x0071, 0x0072, 0x0079], got {}\"}}", cluster_id);
    }
